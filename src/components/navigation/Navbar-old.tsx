    ...
    return (
        <div class="w-full overflow-hidden">
            <nav class="flex items-center justify-end py-3 px-4">
                ...
                <div class={`fixed inset-0 bg-blue-dark pointer-events-none ${isOpen ? "opacity-100" : "opacity-0"}`}>
                    <div
                        class={`absolute top-0 right-0 bottom-0 z-50 w-10/12 transform bg-black-dark p-6 duration-300 ease-out ${
